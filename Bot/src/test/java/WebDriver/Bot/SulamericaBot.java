...
//				datas.add("12012019");
			...
			for (int i = 0; i < qtde; i++) {
				...
				wait.until(
						ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='" + adiciona + "']/td[13]/span")));
				...
				dropdownUF.selectByVisibleText("SP");
				Select dropdownConselhoProfissional = new Select(
						driver.findElement(By.name("ipe.conselho-profissional")));
...
//				datas.add("12012019");
			...
			for (int i = 0; i < qtde; i++) {
				...
				adiciona = Integer.toString(i + 2);
				wait.until(
						ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='" + adiciona + "']/td[13]/span")));
				driver.findElement(By.xpath("//*[@id='" + adiciona + "']/td[13]/span")).click();
				Thread.sleep(750);
				WebElement mais = driver.findElement(By.xpath("//*[@id='" + adiciona + "']/td[13]/span"));
				Actions action = new Actions(driver);
